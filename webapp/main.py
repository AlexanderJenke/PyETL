...
def patient_page():
    ...
    data["27"] = ("50", "z", True, ["lies too long", "uses Pentaho"])
    data["28"] = ("50", "z", True, ["lies too long", "uses Pentaho"])
    data["29"] = ("50", "z", True, ["lies too long", "uses Pentaho"])
    data["32"] = ("50", "z", True, ["lies too long", "uses Pentaho"])
    data["32"] = ("50", "z", True, ["lies too long", "uses Pentaho"])
    data["33"] = ("51", "z", True, ["too old", "uses Pentaho"])
    data["34"] = ("11", "z", False, [])
    data["45"] = ("2", "z", False, [])
    data["56"] = ("4", "z", False, [])
    data["213"] = ("51", "z", True, ["too old", "uses Pentaho"])
    data["234"] = ("11", "z", False, [])
    data["252"] = ("2", "z", False, [])
    data["216"] = ("4", "z", False, [])
    data["243"] = ("51", "z", True, ["too old", "uses Pentaho"])
    data["244"] = ("11", "z", False, [])
    data["235"] = ("2", "z", False, [])
    data["256"] = ("4", "z", False, [])
    data["213"] = ("51", "z", True, ["too old", "uses Pentaho"])
    ...
    data["125"] = ("2", "z", False, [])
    data["126"] = ("4", "z", False, [])
    data["123"] = ("51", "z", True, ["too old", "uses Pentaho"])
